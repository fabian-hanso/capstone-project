...
function Dashboard({ letActiveUser, onHandleLogout }) {
  ...
  return (
    <Wrapper>
      ...
      <OffCanvas menuIsOpen={menuIsOpen}>
        ...
        <BodyWrapper>
          <BigHeadlineWhite>
            Wo darf's hingehen,
            <br />
            <span>{letActiveUser}?</span>
          </BigHeadlineWhite>
          <LinkArea>
            <CanvasLinkColor to="/tasks">
              <img src={linkarrow} alt="Arrow next" />
              Hausaufgaben
            </CanvasLinkColor>
            <CanvasLinkColor to="/plan">
              <img src={linkarrow} alt="Arrow next" />
              Stundenplan
            </CanvasLinkColor>
            <CanvasLinkColor to="/inbox">
              <img src={linkarrow} alt="Arrow next" />
              Postfach
            </CanvasLinkColor>
            <CanvasLinkColor to="/subjects">
              <img src={linkarrow} alt="Arrow next" />
              Bücher
            </CanvasLinkColor>
      ...
      <HeaderWrapper>
        <MenuButton onClick={openMenuHandler}>
          <img src={home} alt="Open Menu" />
        </MenuButton>
      </HeaderWrapper>
      <BodyWrapper>
        <BigHeadline>
          {Greeting ? "Guten Abend, " : "Guten Morgen, "}
          <br />
          <span>{letActiveUser}!</span>
        </BigHeadline>
        ...
        <GridWrapper>
          <FullWidthLink>
            ...
            <DashboardText>
              {newMessages
                ...
                : "Du hast keine ungelesene Nachrichten in deinem Postfach!"}
            </DashboardText>
          ...
          <StundenLink>
            ...
            <DashboardText>
              In kürze kannst du hier alle Aktualisierungen des Stundenplans
              einsehen.
            </DashboardText>
            <Link to="/plan" className="Link_white">
              <img src={arrownextblue} alt="next"></img>
            </Link>
          </StundenLink>
        </GridWrapper>
      </BodyWrapper>
